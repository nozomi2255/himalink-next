...
const formatTimeSince = (timeSince?: string) => {
  if (!timeSince) return ""; // Handle undefined case
                                ...
                                return (
                                    <div key={dateStr} id={`date-${dateStr}`} className="py-2">
                                        ...
                                        <div className="space-y-4 px-4 mt-2">
                                            ...
                                            {eventsOnDate.map((event: Event, index) => (
                                                                        ...
                                                                        <div className="flex-1">
                                                                            <div className="flex items-baseline gap-2">
                                                                              ...
                                                                              <span className="text-xs text-gray-400">
                                                                                  {formatTimeSince((event as any).time_since_update)}
                                                                              </span>
                                                                            </div>
                                                                            {event.location && (
        ...
        return (
            <Sheet open={open} onOpenChange={onOpenChange} modal={false}>
                ...
                >
                    ...
                    <SheetHeader className="px-4 pt-2 pb-1 border-b">
